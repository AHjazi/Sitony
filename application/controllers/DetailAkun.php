...
class DetailAkun extends CI_Controller {
	...
	{
		$this->form_validation->set_rules('id_user','username','password','nip','nama','divisi','email','no_telp,','goldar','required');
