<div class="col-xl-13" style="margin-left:25px;margin-right:25px;margin-top:25px;">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('./adming/sparepart/update_data_aksi/' . $sparepart['id_sparepart'])?>"
                method="POST">
                <div class="mb-3 row">
                ...
                <div style="margin-left:10px;margin-top:10px;">
                    <a type="submit"><button class="btn rounded-pill btn-success"><i class='bx bxs-save'></i>
                            Simpan</i></button></a>
                    <a href="<?php echo base_url('./adming/sparepart')?>"><button class="btn rounded-pill btn-danger"><i
