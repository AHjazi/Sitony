<div class="card" style="margin-left:25px;margin-right:25px;margin-top:25px;">
    ...
    <div class="table-responsive text-nowrap">
        <td><a href="<?php echo base_url('./adming/bahanbakar/tambah_bahanbakar')?>"><button
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                    href="<?php echo base_url('./adming/bahanbakar/edit_bahanbakar/'. $p->id_bahanbakar)?>"><i
                                        class="bx bx-edit-alt me-1"></i>
                                    Edit</a>
                                <a class="dropdown-item"
                                    href="<?php echo base_url('./adming/bahanbakar/hapus_bahanbakar/'. $p->id_bahanbakar)?>"><i
